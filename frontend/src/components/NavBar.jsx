...
//lucid has all these icons above.
...
const Navbar = () => {
	...
	return (
      ...
      {/*above header so fixed at top of nav, with defind bottom border*/}
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					<Link to='/' className='text-5xl font-stylescript text-blue-400 items-center space-x-2 flex'>
						Essenza
					</Link>
          {/*Above link takes us to the home page */}
                ...
                {/*Below icon from lucide react */}
						...
						{isAdmin && (
							<Link
								...
								to={"/secret-dashboard"}
							>
                {/*Lock icon from lucide react for Admin DashBoard*/}
